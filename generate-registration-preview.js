 ...
 */
function createRegistrationEmailHtml(parentName) {
  return `<!doctype html>
...
const outputPath = path.join(__dirname, 'registration-email-preview.html');
...
console.log('\n📋 Recipients:');
console.log('   - All emails from Newsletter table');
console.log('   - All parent emails from Enrollment table (isactive = true or false)');
