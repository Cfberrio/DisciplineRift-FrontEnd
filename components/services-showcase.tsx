    ...
    <section className="py-20 bg-gray-50" id="services">
      <div className="container px-4">
        <AnimatedSection animation="fade-down" className="text-center mb-12">
          <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl wild-youth-text-blue mb-3 xs:mb-4 sm:mb-6 px-4 xs:px-0">AVAILABLE TEAMS</h2>
          <p className="text-sm xs:text-base sm:text-lg md:text-xl text-gray-700 max-w-3xl mx-auto px-4 sm:px-0">
