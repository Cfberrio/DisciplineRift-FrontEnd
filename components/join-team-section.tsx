...
<body>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitFormData.append('consentTransactional', String(formData.consentTransactional))
      submitFormData.append('consentMarketing', String(formData.consentMarketing))
