/**
 * Script simplificado para enviar correos AHORA
 * Envía directamente usando las configuraciones conocidas
 */
...
console.log('🚀 === ENVIANDO CORREO DE PRUEBA INMEDIATAMENTE ===');
console.log(`📧 Desde: ${GMAIL_USER}`);
console.log(`🎯 Para: ${GMAIL_USER} (auto-envío para prueba)`);
