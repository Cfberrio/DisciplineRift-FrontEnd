...
async function generatePreview() {
  try {
    console.log('🔍 Generando preview del correo de recordatorio del día anterior para September 16, 2025...');
    ...
    console.log('✅ Condiciones: enrollment.isactive = true AND team.isactive = true');

    // Buscar sesiones que inician en esa fecha con equipos activos
    ...
    if (!sessions || sessions.length === 0) {
      console.log('❌ No hay sesiones para esa fecha con equipos activos');
      return;
    }
    ...
    // Guardar el preview
    const fs = require('fs');
    const fileName = 'real-tuesday-16-preview.html';
    ...
    console.log(`   - enrollment.isactive = true ✓`);
    console.log(`   - team.isactive = true ✓`);
