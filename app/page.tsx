  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="flex flex-col bg-pattern">
        ...
        <section
          id="about"
          className="py-8 xs:py-12 sm:py-16 md:py-20 bg-cover bg-center min-h-screen"
            ...
            <div className="flex flex-col md:flex-row md:justify-end">
              <div className="w-full md:w-1/2 lg:w-2/5">
                <AnimatedSection animation="fade-left" delay={200}>
                  <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl ethnocentric-text-blue mb-3 xs:mb-4 sm:mb-6 px-4 xs:px-0">ABOUT US</h2>
                </AnimatedSection>
                <AnimatedSection animation="fade-left" delay={400}>
                  <p className="mission-text-large text-gray-800 mb-4 xs:mb-6 px-4 xs:px-0 text-sm xs:text-base sm:text-lg md:text-xl">
