// Script para generar preview del correo de recordatorio del día anterior para Monday 15 September 2025
...
async function generatePreview() {
  try {
    console.log('🔍 Generando preview del correo de recordatorio del día anterior para September 15, 2025...');

    // Fecha objetivo: Monday, September 15, 2025
    ...
    // Guardar el preview
    const fs = require('fs');
    const fileName = 'real-monday-15-preview.html';
