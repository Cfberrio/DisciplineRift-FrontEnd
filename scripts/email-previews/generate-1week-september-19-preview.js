// Script para generar preview del correo de recordatorio de 1 semana para sesiones del Friday 19 September 2025
...
async function generatePreview() {
  try {
    console.log('🔍 Generando preview del correo de recordatorio de 1 semana para September 19, 2025...');

    // Fecha objetivo: Friday, September 19, 2025
    ...
    // Guardar el preview
    const fs = require('fs');
    const fileName = 'real-1week-september-19-preview.html';
