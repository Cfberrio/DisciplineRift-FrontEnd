...
console.log('🚀 === ENVIANDO CORREO DE RECORDATORIO DE PAGO INCOMPLETO ===');

// Configuración exacta que funciona en el proyecto
...
const createIncompletePaymentReminderTemplate = (parentFirstName: string) => {
  return `<!DOCTYPE html>
...
async function sendIncompletePaymentReminderEmail(
  parentEmail: string,
  parentFirstName: string
) {
  try {
    console.log(`📧 Enviando correo a: ${parentEmail}`);
    ...
    console.log(`🎯 Enviado a: ${parentEmail}`);
...
async function main() {
  try {
    ...
    console.log(`   - Template: Recordatorio de pago incompleto`);
    console.log('');
    
    // Enviar email de prueba
    await sendIncompletePaymentReminderEmail(GMAIL_USER, 'Carlos');
